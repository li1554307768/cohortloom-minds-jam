...
def test_settings_from_environment(monkeypatch: pytest.MonkeyPatch) -> None:
    monkeypatch.setenv("COHORTLOOM_DATABASE_PATH", "data/custom.db")
    monkeypatch.setenv("COHORTLOOM_CREDIT_FLOOR", "12")
    monkeypatch.setenv("COHORTLOOM_MIND_ID", "00000000-0000-4000-8000-000000000001")
...
def test_credit_floor_cannot_be_weakened(monkeypatch: pytest.MonkeyPatch) -> None:
    monkeypatch.setenv("COHORTLOOM_CREDIT_FLOOR", "9")
